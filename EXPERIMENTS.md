...
- `CLF_STEM_LEVE` e `CLF_LABEL_SMOOTHING` implementados em `model.py`/`train.py` (desligados por padrão) mas **não commitados/testados em treino real ainda** — próximo experimento planejado.
