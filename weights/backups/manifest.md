...
| `weights/classifier_best.pt` (ativo, não está aqui) | 2026-07-23 | `stem_leve` + `label_smoothing=0.1`, treino interrompido na época 15/30, `val_acc=98.53%`. Recall corpus completo (multiset): **86.78%**, OUTROS 92.3%. Foi o ativo, brevemente substituído em 2026-08-01 por um checkpoint com regressão confirmada (ver linha abaixo), e reinstalado como ativo no mesmo dia após o revert. Ver `EXPERIMENTS.md`. |
