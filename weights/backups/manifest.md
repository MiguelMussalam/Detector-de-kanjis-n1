...
| `classifier_2026-07-23.pt` | 2026-07-23 | `stem_leve` + `label_smoothing=0.1`, treino interrompido na época 15/30, `val_acc=98.53%`. Recall corpus completo (multiset): **86.78%**, OUTROS 92.3%. Foi o ativo até 2026-08-01. Ver `EXPERIMENTS.md`. |
| `weights/classifier_best.pt` (ativo, não está aqui) | 2026-08-01 | Mesma receita de 2026-07-23 (`stem_leve`, `label_smoothing`) + fixes desta sessão incorporados (correção do no-op de `apply_translate_and_crop`, `CLF_MORFO_PROB_COM_TRANSLACAO` reduzindo co-ocorrência morfologia+translação, troca de 3 fontes por `GenEi-Antique-M`/`GenEi-Gothic-KL-H`). 18 epochs, `val_acc=98.82%`. **Sinal misto na promoção**: amostra local de 50 páginas deu recall **84.5%** (213/252), pior que os 88.1% do checkpoint anterior na mesma amostra — ainda não confirmado se é ruído de amostra (252 pares é pouco) ou regressão real; validação full-corpus no Kaggle pendente pra decidir. Ver `EXPERIMENTS.md`. |
